package io.github.quinnandrews.spring.data.geo.us.states;
...
public class GeoState {
	...
	private static final String STATE_SHAPE_PROPERTIES_FILE = "io/github/quinnandrews/spring/data/geo/us/states/source/state-shape.properties";
	...
	public GeoState(final String name, final String code) {
		this.name = name;
		this.code = code;
		this.shape = renderShape(getShapeProperty(name));
	}

	public GeoState(final String name, final String code, final String shapePropertyName) {
		this.name = name;
		this.code = code;
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("name", name).append("code", code)
				.toString();
	}
}
