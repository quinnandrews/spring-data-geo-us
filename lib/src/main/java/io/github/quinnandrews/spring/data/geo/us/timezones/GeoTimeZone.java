package io.github.quinnandrews.spring.data.geo.us.timezones;
...
@Generated("io.github.quinnandrews.spring.data.geo.us.generator.timezones.GeoTimeZoneGenerator")
public class GeoTimeZone {

	private static final String TIME_ZONE_SHAPE_PROPERTIES_FILE = "io/github/quinnandrews/spring/data/geo/us/timezones/source/timezone-shape.properties";
	...
	public GeoTimeZone(final ZoneId zoneId, final TimeZone timeZone, final String shapePropertyName) {
		this.zoneId = zoneId;
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("zoneId", zoneId).toString();
	}
}
